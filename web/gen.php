	...
	<a href="index.php"> <div id="header"> </div> </a>
		...
		<div class="container-fluid">
			...
			<form method="post">
				...
				<button type="button" class="btn btn-info" id="checkQuestions"  >Add question</button>            
				<button type="submit" class="btn btn-primary" id="submitQuestions" name="submitted">Generate</button>
			</form>
		</div>
